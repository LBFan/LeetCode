package com.leetcode.fan.fptree;
...
public class FPTree {
    ...
    public List<List<String>> readTransRocords(String... filenames) {
        ...
        if (filenames.length > 0) {
            ...
            temp.add("牛奶 鸡蛋 面包 薯片");
            temp.add("鸡蛋 爆米花 薯片 啤酒");
            temp.add("鸡蛋 面包 薯片");
            temp.add("牛奶 鸡蛋 面包 爆米花 薯片 啤酒");
            temp.add("牛奶 面包 啤酒");
            temp.add("鸡蛋 面包 啤酒");
            temp.add("牛奶 面包 薯片");
            temp.add("牛奶 鸡蛋 面包 黄油 薯片");
            temp.add("牛奶 鸡蛋 黄油 薯片");
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> transRecords = fptree
                .readTransRocords("/User/HuXin/Document/workspace/LeetCode/src/com/leetcode/fan/fptree/foods.txt");
